...
;; ## added by OPAM user-setup for emacs / ocp-indent ## d71d10c54c768a44234452d669054eab ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (assoc "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/tienson/.opam/4.04.0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/tienson/.opam/4.04.0/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/tienson/.opam/4.04.0/bin/ocp-indent"))
;; ## end of OPAM user-setup addition for emacs / ocp-indent ## keep this line
;; ## added by OPAM user-setup for emacs / tuareg ## 733fe7aaa55f2de778bc5286472923ec ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/tienson/.opam/4.04.0/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
